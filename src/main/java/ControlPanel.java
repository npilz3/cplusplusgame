...
public class ControlPanel extends JPanel {
    ...
    public ControlPanel() {
        ...
        custom1 = new JButton("Glaceon");
        custom1.addActionListener(new ButtonListener("Glaceon"));
        add(custom1);


        custom2 = new JButton("Mudkip");
        custom2.addActionListener(new ButtonListener("Mudkip"));
        add(custom2);
